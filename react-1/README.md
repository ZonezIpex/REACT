...
- [`react.dev`](https://react.dev)에서 제공하는 공식 문서는  
  **Get Start**와 **Learn React**로 구성되어 있습니다.

- 이번에 학습한 내용은 **Get Start** 아래의  
  → `Quick Start`, `Installation`, `Setup` 챕터로 구성됩니다.

---

### 🚀 Quick Start에서 학습한 내용

1. **React의 전체 내용을 빠르게 학습**할 수 있도록 요약된 설명  
2. **Tic-Tac-Toe 게임 개발 예제**를 통해  
   → 주요 개념을 **프로젝트에 적용하는 방법**을 실습  
...
- **개발환경 설정과 TypeScript 도입** 중심으로 학습함

---

- 아직도 React의 기본 개념이 어렵다면  
  → **Quick Start를 다시 한 번 학습할 것**을 추천합니다.

- 만약 이 강의를 모두 이해했다면  
  → 이제 **Learn React**를 학습해 보세요!
